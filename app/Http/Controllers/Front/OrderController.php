    ...
    public function store(){
        ...
        foreach(carts() as $item){
            $order->items()->create([
              ...
              'product_name' =>  app()->getLocale()== "en"?  $item->product->title_en :  $item->product->title_en,
        ...
        return back()->with('success','The Order Has Been Sent Successfully and the Order Code Is'.'<br>'.$data['code']);
    }
