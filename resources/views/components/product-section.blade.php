                ...
                <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                    <div class="filter-col1 p-r-15 p-b-27">
                        ...
                        <ul>
                            ...
                            <li class="p-b-6">
                                <a href="{{ filterByLinkQuery(url()->current(),'sort_by' ,'price_low') }}" class="filter-link stext-106 trans-04   {{ filterActiveClass('filter-link-active ','sort_by','price_low')}}">
                                    Price: Low to High
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="{{ filterByLinkQuery(url()->current(),'sort_by' ,'price_high') }}" class="filter-link stext-106 trans-04 {{ filterActiveClass('filter-link-active ','sort_by','price_high')}}">
                                    Price: High to Low
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="filter-col2 p-r-15 p-b-27">
                        ...
                        <ul>
                            <li class="p-b-6">
                                <a href="{{ filterByLinkQuery(url()->current(),'price_between') }}" class="  {{ filterActiveClass('filter-link-active ','price_between')}}  filter-link stext-106 trans-04 filter-link-active">
                                    All
                                </a>
                            </li>
