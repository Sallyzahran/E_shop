      ...
      <li class="nav-item dropdown">
       ...
       @endif
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <span class="dropdown-item dropdown-header">{{ $adminNote->count() }} New Notification</span>
          @endif

          @forelse ($adminNote as $note)
          <a href="{{ url('admin/notes') }}" class="dropdown-item">
            <i class="fas fa-file mr-2"></i> {{ $note->title }}
          </a>
          @empty
          ...
          <a href="{{ url('admin/notes') }}" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admins.index', ['id'=>1]) }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('sliders.index', ['id'=>1]) }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Slider
          ...
          <li class="nav-item">
            <a href="{{ route('categories.index', ['id'=>1]) }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Categories
          ...
          <li class="nav-item">
            <a href="{{ route('products.index', ['id'=>1]) }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Products
          ...
          <li class="nav-item">
            <a href="{{ route('tags.index', ['id'=>1]) }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Tags
